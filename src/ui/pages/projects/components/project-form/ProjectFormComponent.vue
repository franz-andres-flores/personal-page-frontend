                    ...
                    <q-form @submit="onSubmit">
                        <div class="row">
                            <div class="col-12 q-pa-sm">
                                <q-input filled v-model="name" label="Nombre *" hint="Nombre del proyecto" lazy-rules
                                    :dense="true" clearable :rules="validationRules.textFieldRequired" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 q-pa-sm">
                                <q-input v-model="description" :dense="true" label="Descripción"
                                    hint="Descripción del proyecto" filled type="textarea"
                        ...
                        <div class="row">
                            <div class="col-12 q-pa-sm">
                                <q-input filled v-model="urlRepository" label="Url Repositorio *"
                                    hint="Url del repositorio del proyecto" lazy-rules :dense="true" clearable
                                    :rules="validationRules.textFieldRequired" />
                            </div>
                        </div>
